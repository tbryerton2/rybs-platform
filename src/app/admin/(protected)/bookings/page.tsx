...
async function getBookings(businessId: string, limit = 1000) {
...
async function getSearchSupplementalBookings(query: string, businessId: string) {
...
async function getLinkedCustomers(customerIds: string[], businessId: string) {
...
async function getActiveHolds(businessId: string) {
...
export default async function AdminBookingsPage({
  ...
  const linkedCustomers = await getLinkedCustomers(customerIds, adminSession.business.id);

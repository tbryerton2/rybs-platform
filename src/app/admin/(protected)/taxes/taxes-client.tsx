    ...
    <div className="space-y-8">
      <section className="grid gap-4 sm:grid-cols-3">
        {[
          ...
          <div key={stat.label} className="rounded-[20px] border border-slate-200 bg-white p-5 shadow-sm ring-1 ring-slate-200/60">
      ...
      <section className="grid gap-8 xl:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)]">
          ...
          <div className="rounded-[20px] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <dl className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={label} className="rounded-[14px] border border-slate-200 bg-slate-50/70 p-4">
        ...
        <div className="space-y-8">
          <div className="rounded-[20px] border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              {checkpoints.map((checkpoint) => (
                <div key={checkpoint.id} className="rounded-[14px] border border-slate-200 bg-slate-50/70 p-4">
          ...
          <div className="rounded-[20px] border border-slate-200 bg-slate-50/80 p-6 shadow-sm">

  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC] text-[#0F172A]">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3">
                <form
                  ...
                  className="flex flex-col gap-3 rounded-3xl bg-white p-3 shadow-sm ring-1 ring-gray-200 sm:flex-row sm:items-center"
                >
                  <input
                    inputMode="numeric"
      ...
      <div className="mx-auto max-w-6xl space-y-16 px-6 pb-24">
          ...
          <section>
            ...
            <div className="mt-8 grid gap-4">
              {faqContent.items.map((item) => (
                <details key={item.question} className="group rounded-[20px] bg-white p-6 shadow-sm ring-1 ring-slate-200">
                  <summary className="flex cursor-pointer list-none items-center justify-between font-semibold text-[#0F172A]">
                    <span>{item.question}</span>
                    <span className="text-[#F97316] transition group-open:rotate-180">⌄</span>
                  </summary>
        ...
        <section className="-mx-6 mt-16 bg-slate-50 px-6 py-10">
          <div className="w-full rounded-[28px] bg-white p-8 shadow-sm ring-1 ring-slate-200 md:p-10">
